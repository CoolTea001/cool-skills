---
name: cool-design
description: Nuxt design system, powered by Nuxt UI and Tailwind CSS v4. Dark mode is the default theme. Use for all UI implementation and page design tasks.
version: alpha
brand:
  green: "#00DC82"
  navy: "#020420"
